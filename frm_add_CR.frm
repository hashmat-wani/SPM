...
Begin VB.Form frm_add_CR 
   ...
   End
End
Attribute VB_Name = "frm_add_CR"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub cmb_batch_Click()
cmb_batch.BackColor = vbWhite
txt_regno.Text = ""
End Sub
...
cmd_students_list.Enabled = True
txt_regno.Text = ""
End Sub
...
Else
        Call connection
        rs.Open "insert into CR values('" & Trim(txt_regno.Text) & "'," & d_id & "," & c_id & ",'" & cmb_sem & "','" & cmb_sec & "','" & cmb_batch & "')", conn, adOpenDynamic, adLockBatchOptimistic
...
cmd_students_list.Enabled = False
...
cmb_batch.Clear
txt_regno.Text = ""
For Each ctr In frm_add_CR.Controls
