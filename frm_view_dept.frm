...
Begin VB.Form frm_view_dept 
   ...
   End
End
Attribute VB_Name = "frm_view_dept"
...
Call connection
rs.Open "select count(id) from department", conn, adOpenDynamic, adLockBatchOptimistic
Dim n As Integer
n = rs.Fields(0)
Call connection
...
If MSFlexGrid1.Row <> 0 Then
    frm_edit_department.Show
    frm_edit_department.txt_id.Text = MSFlexGrid1.TextMatrix(MSFlexGrid1.Row, 0)
    frm_edit_department.txt_dept_name.Text = MSFlexGrid1.TextMatrix(MSFlexGrid1.Row, 1)
    Unload Me
End If
End Sub
