VERSION 5.00
Begin VB.Form frm_edit_cc 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Update Class_coordinator details"
   ClientHeight    =   3735
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   6975
   ...
   Begin VB.Frame Frame2 
      Caption         =   "Update Class Coordinator Details"
      BeginProperty Font 
   ...
   End
End
Attribute VB_Name = "frm_edit_cc"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim sem As Integer
Dim o_did, o_cid, o_sem, o_sec As Integer
Dim o_sect As String
...
d_id = rs.Fields(0)
Call connection
rs.Open "update class_coordinator set teacherid = null where deptid = " & d_id & " and courseid = " & c_id & " and semester = " & sem & " and section = '" & cmb_sec & "'", conn, adOpenDynamic, adLockBatchOptimistic
...
Else
        Call connection
        rs.Open "update class_coordinator set teacherid = null where deptid = " & o_did & " and courseid = " & o_cid & " and semester = " & o_sem & " and section = '" & o_sect & "'", conn, adOpenDynamic, adLockBatchOptimistic
        Call connection
...
cmb_teacher_name.Enabled = False
cmd_update.Enabled = False
For Each ctr In frm_edit_cc.Controls
