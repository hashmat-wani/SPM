...
Begin VB.Form frm_edit_get_regno 
   ...
   End
End
Attribute VB_Name = "frm_edit_get_regno"
...
Call connection
rs.Open "select id from course where name = '" & frm_edit_cr.cmb_course_name & "'", conn, adOpenDynamic, adLockBatchOptimistic
c_id = rs.Fields(0)
Call connection
rs.Open "select count(regno) from student where batch = '" & frm_edit_cr.cmb_batch & "' and semester = '" & frm_edit_cr.cmb_sem & "' and courseid = " & c_id & " and section = '" & frm_edit_cr.cmb_sec & "'", conn, adOpenDynamic, adLockBatchOptimistic
Dim n As Integer
n = rs.Fields(0)
Call connection
rs.Open "select regno,name from student where batch = '" & frm_edit_cr.cmb_batch & "' and semester = '" & frm_edit_cr.cmb_sem & "' and courseid = " & c_id & " and section = '" & frm_edit_cr.cmb_sec & "'", conn, adOpenDynamic, adLockBatchOptimistic
